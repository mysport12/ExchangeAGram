...
//  ExchangeAGram
//
//  Created by Craig Martin on 3/17/15.
...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func saveFilterToCoreData(indexPath: NSIndexPath, caption: String) {
        let filterImage = self.filteredImageFromImage(self.thisFeedItem.image, filter: self.filters[indexPath.row])
        let filterImageData = UIImageJPEGRepresentation(filterImage, 1.0)
        self.thisFeedItem.image = filterImageData
        let filterThumbNailData = UIImageJPEGRepresentation(filterImage, 0.1)
        self.thisFeedItem.thumbNail = filterThumbNailData
    ...
    //UIAlertView Helper Functions
    
    func createUIAlertController(indexPath: NSIndexPath) {
        
        let alert = UIAlertController(title: "Photo Options", message: "Please enter an option", preferredStyle: UIAlertControllerStyle.Alert)
        ...
        let photoAction = UIAlertAction(title: "Post Photo to Facebook with Caption", style: UIAlertActionStyle.Destructive) { (UIAlertAction) -> Void in
            ...
            self.shareToFacebook(indexPath, caption: text as String)
        }
        ...
        let saveFilterAction = UIAlertAction(title: "Save Filter without Posting to Facebook", style: UIAlertActionStyle.Default) { (UIAlertAction) -> Void in
            ...
            self.saveFilterToCoreData(indexPath, caption: text as String)
        }
